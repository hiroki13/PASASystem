...
public class Parser {
    ...
    public Parser(int c_length, int sent_num, int max_sent_len, int weight_len) {
        this.case_length = c_length;
        this.perceptron = new Perceptron(case_length, sent_num, max_sent_len, weight_len);
    }
    ...
    private ArrayList<Integer> extractFeature(Sentence sentence, int prd_id, int arg_id, int case_label){
        return perceptron.feature.extractFeature(sentence, prd_id, arg_id, case_label);
    }
    ...
    final public ArrayList extractFeature(Sentence sentence, int[][] o_graph){
        final ArrayList feature = new ArrayList<>();
